...
# -*- encoding: utf-8 -*-
# stub: friendly_id-method_scopes 0.3.7 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rails>.freeze, [">= 4", "< 7"])
      s.add_runtime_dependency(%q<friendly_id>.freeze, [">= 5", "< 6"])
      s.add_development_dependency(%q<juwelier>.freeze, ["~> 2"])
      s.add_development_dependency(%q<sqlite3>.freeze, ["~> 1"])
      s.add_development_dependency(%q<rspec-rails>.freeze, [">= 4.0.1", "< 5"])
      s.add_development_dependency(%q<shoulda-matchers>.freeze, [">= 4.3", "< 5"])
      s.add_development_dependency(%q<rolify>.freeze, [">= 4", "< 6"])
      s.add_development_dependency(%q<seedbank>.freeze, ["~> 0.3"])
      s.add_development_dependency(%q<factory_bot_rails>.freeze, [">= 4.8.2", "< 6"])
      s.add_development_dependency(%q<faker>.freeze, [">= 2.12", "< 3"])
      s.add_development_dependency(%q<haml>.freeze, ["~> 5"])
      s.add_development_dependency(%q<database_cleaner>.freeze, ["~> 1.4"])
      s.add_development_dependency(%q<rails-controller-testing>.freeze, [">= 1", "< 2"])
      s.add_development_dependency(%q<coveralls>.freeze, ["~> 0.8"])
    else
      s.add_dependency(%q<rails>.freeze, [">= 4", "< 7"])
      s.add_dependency(%q<friendly_id>.freeze, [">= 5", "< 6"])
      s.add_dependency(%q<juwelier>.freeze, ["~> 2"])
      s.add_dependency(%q<sqlite3>.freeze, ["~> 1"])
      s.add_dependency(%q<rspec-rails>.freeze, [">= 4.0.1", "< 5"])
      s.add_dependency(%q<shoulda-matchers>.freeze, [">= 4.3", "< 5"])
      s.add_dependency(%q<rolify>.freeze, [">= 4", "< 6"])
      s.add_dependency(%q<seedbank>.freeze, ["~> 0.3"])
      s.add_dependency(%q<factory_bot_rails>.freeze, [">= 4.8.2", "< 6"])
      s.add_dependency(%q<faker>.freeze, [">= 2.12", "< 3"])
      s.add_dependency(%q<haml>.freeze, ["~> 5"])
      s.add_dependency(%q<database_cleaner>.freeze, ["~> 1.4"])
      s.add_dependency(%q<rails-controller-testing>.freeze, [">= 1", "< 2"])
